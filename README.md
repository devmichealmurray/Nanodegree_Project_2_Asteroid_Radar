# Nanodegree_Project_2_Asteroid_Radar
Project for the Udacity Android Kotlin Nanodegree.

## Project Objectives

Show proficiency in parsing JSON without the use of a converter, like Moshi.
The ability to properly implement Retrofit for networking and Room for data persistence.
Correctly implementing WorkManager to schedule data downloads and caching.
Project must implement LiveData, RecyclerView, and Navigation.
